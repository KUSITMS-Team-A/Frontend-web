...
export default function Contact() {
  ...
  const typeStyles49: { [key: string]: { value: ReactNode } } = {
    음식점: {
      value: <Image src={Food} alt="food marker" width={49} height={49} />,
    },
    카페: {
      value: <Image src={Cafe} alt="cafe marker" width={49} height={49} />,
    },
    미용: {
      value: <Image src={Beauty} alt="Beauty marker" width={49} height={49} />,
    },
    문화: {
      value: (
        <Image src={Culture} alt="Culture marker" width={49} height={49} />
      ),
    },
    기타: {
      value: <Image src={Etc} alt="Etc marker" width={49} height={49} />,
    },
  };
